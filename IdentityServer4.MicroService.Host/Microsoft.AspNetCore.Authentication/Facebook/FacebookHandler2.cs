...
{
    public class FacebookHandler2 : TenantOAuthHandler<FacebookOptions>
    {
        public FacebookHandler2(IOptionsMonitor<FacebookOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
