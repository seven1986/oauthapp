...
{
    public class VisualStudioAuthenticationHandler : TenantOAuthHandler<VisualStudioAuthenticationOptions>
    {
        public VisualStudioAuthenticationHandler(
            IOptionsMonitor<VisualStudioAuthenticationOptions> options,
